...
class SearchDestacados extends StatefulWidget {
  @override
  _SearchDestacadosState createState() => _SearchDestacadosState();
}

class _SearchDestacadosState extends State<SearchDestacados> {
          ...
          GetBuilder<dataController>(
            ...
            builder: (val) {
              return IconButton(
                  ...
                  onPressed: () {
                    val
                        .queryDestacadosData(searchController.text)
                        .then((value) {
                      snapshotData = value;
                      setState(() {
                        isExcecuted = true;
