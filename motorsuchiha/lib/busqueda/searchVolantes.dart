...
class SearchVolantes extends StatefulWidget {
  @override
  _SearchVolantesState createState() => _SearchVolantesState();
}

class _SearchVolantesState extends State<SearchVolantes> {
          ...
          GetBuilder<dataController>(
            ...
            builder: (val) {
              return IconButton(
                  ...
                  onPressed: () {
                    val.queryvolantesData(searchController.text).then((value) {
                      snapshotData = value;
                      setState(() {
                        isExcecuted = true;
                      });
