...
class SearchNuevos extends StatefulWidget {
  @override
  _SearchNuevosState createState() => _SearchNuevosState();
}

class _SearchNuevosState extends State<SearchNuevos> {
          ...
          GetBuilder<dataController>(
            ...
            builder: (val) {
              return IconButton(
                  ...
                  onPressed: () {
                    val.queryNuevoData(searchController.text).then((value) {
                      snapshotData = value;
                      setState(() {
                        isExcecuted = true;
                      });
