...
class SearchFarolas extends StatefulWidget {
  @override
  _SearchFarolasState createState() => _SearchFarolasState();
}

class _SearchFarolasState extends State<SearchFarolas> {
          ...
          GetBuilder<dataController>(
            ...
            builder: (val) {
              return IconButton(
                  ...
                  onPressed: () {
                    val.queryfarolasData(searchController.text).then((value) {
                      snapshotData = value;
                      setState(() {
                        isExcecuted = true;
                      });
