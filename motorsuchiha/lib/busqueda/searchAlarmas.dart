...
class SearchAlarmas extends StatefulWidget {
  @override
  _SearchAlarmasState createState() => _SearchAlarmasState();
}

class _SearchAlarmasState extends State<SearchAlarmas> {
          ...
          GetBuilder<dataController>(
            ...
            builder: (val) {
              return IconButton(
                  ...
                  onPressed: () {
                    val.queryAlarmaData(searchController.text).then((value) {
                      snapshotData = value;
                      setState(() {
                        isExcecuted = true;
                      });
